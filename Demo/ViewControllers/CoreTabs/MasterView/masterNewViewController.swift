...
class masterNewViewController: UIViewController, UITextViewDelegate {
    ...
    @IBAction func photoBtns(_ sender: Any) {
    ...
    @IBAction func finishBtn(_ sender: Any) {
        databaseRef = Database.database().reference().child("my/master").childByAutoId()
        ...
        if let data = image.pngData() {
            let imageRef = storageRef.child("master/\(file_name!).png")
...
extension masterNewViewController:UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    //갤러리 띄우기
    func showGallery() {
...
//지역선택
extension masterNewViewController: UIPickerViewDelegate, UIPickerViewDataSource {
