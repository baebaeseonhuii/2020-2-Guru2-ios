 ...
 */
static NSString *const kFIRAuthErrorMessageUserDisabled = @"관리자에 의해 "
                                                           "차단된 사용자입니다.";

/** @var kFIRAuthErrorMessageEmailAlreadyInUse
    @brief Message for @c FIRAuthErrorCodeEmailAlreadyInUse error code.
 */
static NSString *const kFIRAuthErrorMessageEmailAlreadyInUse = @"이미 사용중인 이메일입니다"
                                                                ".";

/** @var kFIRAuthErrorMessageWrongPassword
    @brief Message for @c FIRAuthErrorCodeWrongPassword error code.
 */
static NSString *const kFIRAuthErrorMessageWrongPassword = @"비밀번호가 틀렸거나 "
                                                            "존재하지 않는 사용자입니다.";
...
static NSString *const kFIRAuthErrorMessageTooManyRequests =
    @"비정상적인 동시다발적 로그인 시도로 인해 "
     "해당 기기를 임시로 차단하였습니다. 잠시 후 다시 시도해주세요.";
